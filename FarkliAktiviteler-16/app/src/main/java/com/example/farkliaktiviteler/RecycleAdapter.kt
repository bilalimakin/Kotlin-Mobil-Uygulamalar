...
//ArrayList<Bitmap> çevirdik -> ArrayList<Int>
class RecycleAdapter(val konuListesi : ArrayList<String>, val konuResimleri : ArrayList<Int>) : RecyclerView.Adapter<RecycleAdapter.tarihSorulariVH>(){
    ...
    override fun onBindViewHolder(holder: tarihSorulariVH, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            intent.putExtra("konuResimleriDrawble",konuResimleri.get(position))
